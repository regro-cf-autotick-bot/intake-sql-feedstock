...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/intake-sql-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2421&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/intake-sql-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `intake-sql` can be installed with:

```
conda install intake-sql
```

It is possible to list all of the versions of `intake-sql` available on your platform with:
